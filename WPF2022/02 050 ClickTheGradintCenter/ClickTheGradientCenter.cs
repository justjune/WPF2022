...
namespace Petzold.ClickTheGradientCenter {     
    class ClickTheRadientCenter : Window     {         RadialGradientBrush brush;         
    ...
    {            Title = "Click the Gradient Center";
                 ...
                 Background = brush;         }         
    protected override void OnMouseDown (MouseButtonEventArgs args)//обработка щелчков мыши в клиентской области
    {   double width = ActualWidth                 - 2 * SystemParameters .ResizeFrameVerticalBorderWidth;             
        ...
        ptMouse.X /= width;             
        ptMouse.Y /= height;             
        if (args.ChangedButton == MouseButton .Left)             {                 brush.Center = ptMouse;                 
